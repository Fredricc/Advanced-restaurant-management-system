...
txtHouse_Coffee = Entry(Drinks_F,font=('arial',16,'bold'),bd=8, width=6 , justify=LEFT, state=DISABLED)
...
txtNairobi_Chocolate_Cake = Entry(Cake_F,font=('arial',16,'bold'),bd=8, width=6 , justify=LEFT, state=DISABLED)
txtNairobi_Chocolate_Cake.grid(row=4,column=1)
txtStrawberry_Cheese_Cake = Entry(Cake_F,font=('arial',16,'bold'),bd=8, width=6 , justify=LEFT, state=DISABLED)
...
txtCostofDrinks = Entry(Cost_F,font=('arial',14,'bold'), bg='white', bd=7, insertwidth=2, justify=RIGHT)
...
txtCostofCakes = Entry(Cost_F,font=('arial',14,'bold'), bg='white', bd=7, insertwidth=2, justify=RIGHT)
...
txtServiceCharge = Entry(Cost_F,font=('arial',14,'bold'), bg='white', bd=7, insertwidth=2, justify=RIGHT)
...
txtPaidTax = Entry(Cost_F,font=('arial',14,'bold'), bg='white', bd=7, insertwidth=2, justify=RIGHT)
txtPaidTax.grid(row=0, column=3)

lblSubTotal = Label(Cost_F,font=('arial',14,'bold'),text="\tSub Total\t ",bd=7,bg='Powder Blue', fg='Black')
lblSubTotal.grid(row=1,column=2, sticky=W)
txtSubTotal = Entry(Cost_F,font=('arial',14,'bold'), bg='white', bd=7, insertwidth=2, justify=RIGHT)
txtSubTotal.grid(row=1, column=3)

lblTotalCost = Label(Cost_F,font=('arial',14,'bold'),text="\t Total Cost ",bd=7,bg='Powder Blue', fg='Black')
lblTotalCost.grid(row=2,column=2, sticky=W)
txtTotalCost = Entry(Cost_F,font=('arial',14,'bold'), bg='white', bd=7, insertwidth=2, justify=RIGHT)
...
btnSubt = Button(Cal_F,padx=16, pady=1, bd=7, fg='black', font=('arial',16,'bold'), width=4, text='-', bg='powder blue').grid(row=3, column=3)
...
btnMulti = Button(Cal_F,padx=16, pady=1, bd=7, fg='black', font=('arial',16,'bold'), width=4, text='x', bg='powder blue').grid(row=4, column=3)
